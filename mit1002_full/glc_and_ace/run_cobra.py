...
alt_cobra.medium = glc_medium_inf_o2
glc_only_fba = alt_cobra.optimize()

# Run pFBA- Glucose only
glc_only_pfba = cobra.flux_analysis.pfba(alt_cobra)

# Run FBA- Glucose only with lower O2
alt_cobra.medium = glc_medium_real_o2
glc_low_o2_fba = alt_cobra.optimize()

# Run pFBA- Glucose only with lower O2
glc_low_o2_pfba = cobra.flux_analysis.pfba(alt_cobra)

# Run FBA- Acetate only
alt_cobra.medium = ace_medium_inf_o2
ace_only_fba = alt_cobra.optimize()

# Run pFBA- Acetate only
ace_only_pfba = cobra.flux_analysis.pfba(alt_cobra)

# Run FBA- Acetate only with lower O2
alt_cobra.medium = ace_medium_real_o2
ace_low_o2_fba = alt_cobra.optimize()

# Run pFBA- Acetate only with lower O2
ace_low_o2_pfba = cobra.flux_analysis.pfba(alt_cobra)

# Run FBA- Glucose and Acetate
alt_cobra.medium = mix_medium_inf_o2
mix_fba = alt_cobra.optimize()

# Run pFBA- Glucose and Acetate
mix_pfba = cobra.flux_analysis.pfba(alt_cobra)

# Run FBA- Glucose and Acetate with lower O2
alt_cobra.medium = mix_medium_real_o2
mix_low_o2_fba = alt_cobra.optimize()

# Run pFBA- Glucose and Acetate with lower O2
mix_low_o2_pfba = cobra.flux_analysis.pfba(alt_cobra)
