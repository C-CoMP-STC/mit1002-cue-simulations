...
# Set the glucose to 0.00133, and the acetate to 0.002, and everything else as 1000
# TODO: Check this is correct
# Zac used 8 mM carbon = 0.008 mmol/mL carbon. And glucose has 6 carbons, so
# 0.008 mmol/mL / 6 carbons = 0.001333 mmol/mL glucose
# Zac used 4 mM carbon = 0.004 mmol/mL carbon. And acetate has 2 carbons, so
# 0.004 mmol/mL / 2 carbons = 0.002 mmol/mL acetate
test_tube.set_specific_metabolite('cpd00027_e0', 0.00133)  # Glucose_e0, in mmol
test_tube.set_specific_metabolite('cpd00029_e0', 0.002)  # Acetate_e0, in mmol
