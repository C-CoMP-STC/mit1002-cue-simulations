...
# Set the glucose to 0.0006667, and the acetate to 0.004, and everything else as 1000
# TODO: Check this is correct
# Zac used 8 mM carbon = 0.008 mmol/mL carbon. And acetate has 2 carbons, so
# 0.008 mmol/mL / 2 carbons = 0.004 mmol/mL acetate
# Zac used 4 mM carbon = 0.004 mmol/mL carbon. And glucose has 6 carbons, so
# 0.004 mmol/mL / 6 carbons = 0.0006667 mmol/mL glucose

test_tube.set_specific_metabolite('cpd00027_e0', 0.0006667)  # Glucose_e0, in mmol
test_tube.set_specific_metabolite('cpd00029_e0', 0.004)  # Acetate_e0, in mmol
...
test_tube.set_specific_metabolite('cpd00635_e0', 1000)  # Cbl_e0  # FIXME: This may be being used as an organic carbon source
